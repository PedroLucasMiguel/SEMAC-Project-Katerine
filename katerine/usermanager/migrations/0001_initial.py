# Generated by Django 3.2.6 on 2021-09-27 13:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_description', ckeditor.fields.RichTextField()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='SubscriptionPaymentConfirmation',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('payment_confirmation', models.ImageField(upload_to='')),
                ('user_cpf', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='sub_confirmation', to='usermanager.userpersonaldata')),
            ],
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
                ...
                ('payment_confirmation', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='subscription', to='usermanager.subscriptionpaymentconfirmation')),
